<template> 
    ...
    <div v-if="isModalOpen" class="modal how-to-modal" @click.self="closeModal">
      <div class="modal-content">
        ...
        <p>При клике на маркер открывается окно с подробными данными: имя, фото, статьи, адрес и ссылка на страницу на сайте «Мемориал. Поддержка политзаключённых». Это позволяет узнать больше о судьбе каждого заключённого и, при необходимости, оказать помощь.</p>
